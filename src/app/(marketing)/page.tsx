  ...
  return (
    <>
      <section className="pt-6 pb-8 md:pt-10 md:pb-12 lg:py-32">
        <div className="container mx-auto flex max-h-[64rem] flex-col items-center gap-4 text-center">
          <Link
            href="/"
            className="bg-muted px-4 py-1.5 text-sm font-medium"
          >
            Xをフォローする
          </Link>
          <h1 className="text-3xl font-extrabold sm:text-5xl md:text-6xl lg:text-7xl">Post Writer</h1>
      ...
      <section
        id="features"
        className="container mx-auto space-y-6 bg-slate-200 py-8 md:py-12 lg:py-24"
      >
        <div className="mx-auto max-w-[58rem] space-y-6 text-center">
          <h2 className="text-3xl font-extrabold md:text-6xl">サービスの特徴</h2>
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            このプロジェクトはモダンな技術スタックを使って作られたWebアプリケーションです。Next.js
            AppRouterやContentLayerを利用してマークダウン形式でブログ投稿ができます。
          </p>
        </div>
        <div className="mx-auto grid max-w-[64rem] gap-4 px-8 sm:grid-cols-2 md:grid-cols-3">
          <div className="bg-background rounded border border-slate-300 p-2">
